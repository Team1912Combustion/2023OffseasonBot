...
from wpilib import MotorControllerGroup, Spark, Encoder, AnalogGyro
...
class Drivetrain(SubsystemBase):
    def __init__(self):
        ...
        self.leftMotor = Spark(constants.kLeftMotor1Port)

        self.rightMotor = Spark(constants.kRightMotor1Port)
